...
<?php 
                ...
                if(isset($_GET['id']))
                {
                    ...
                    $lead_row = mysqli_query($conn, "select * from carrnivaltrips_lead where id='$id' ");
                    $lead_data = $lead_row->fetch_assoc();
                    $destination= $lead_data['destination'];


                    $row = mysqli_query($conn, "select * from carrrnivaltrips_destination_wise_silde1 where destination='$destination' ");
                  ...
                  // echo '</pre>';
                    ...
                    $_SESSION['lead_id']=$lead_data['id'];



                }

                $row_details = mysqli_query($conn, "select * from carrnivaltrips_details where id='1' ");
                $data_2 = $row_details->fetch_assoc();
...
<body class="body header-fixed counter-scroll" id="package_body">

    <script type="text/javascript" src="insert_online_ofline.js"></script>

    <div class="preload preload-container">

         <img src="assets/images/logo.webp" alt="Logo" style="margin: 20px 0px; height: 200px; width: 250px;" >
    ...
    <div id="wrapper">
        <div id="pagee" class="clearfix">
                                ...
                                <div class="col-lg-12">
                                    <div class="inner-container flex justify-space align-center" >
                                        ...
                                        <div class="logo-box">
                                            <div class="logo">
                                                <a href="index.php" >
                                                    <img src="assets/images/logo.webp" alt="Logo" style="margin: 20px 0px;" >
                                                </a>

                                                
                                                <!-- <marquee width="70%" direction="right" style="margin-left: 50px; font-size: 20px; font-weight: bold; color: purple;" >
                                        ...
                                        <marquee class="marque_header" width="70%" direction="left" style="margin-left: 30px; font-size: 30px; font-weight: bold; color: blue;" >
                                                Fun Filing and Refeshing Trips , We are Locally Present For Your Memorable Experience.
                                                </marquee>
            ...
            <main id="main">
                ...
                <section class="slider relative">
                    <div class="swiper mySwiper">
                        <div class="swiper-wrapper">
                            ...
                            <!-- slider 1 -->
                            <div class="slider-home1 absulate overflow-hidden swiper-slide">
                                <div class="silider-image">
                                    <img src="../destination_activity/img/<?php echo $data['s1_img']; ?>" alt="Image" class="image-slide">
                                    ...
                                    <div class="booking-title tf-anime-rorate">
                                        <p class="booking"><?php echo $data['s1_squre_box_text']; ?></p>
                                        <span></span>
                                    </div>
                                </div>
                                <div class="slider-content">
                                    <div class="tf-container">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-8">
                                                <span
                                                    class="sub-title text-main font-yes fs-28-46 fadeInDown wow" style="font-size: 70px;" >Hello <?php echo $lead_data['name']; ?></span>
                                                <h1 class="title-slide text-white mb-32 fadeInDown wow"><?php echo $data['s1_text1']; ?><br>
                                                    <span class="animationtext clip text-main">
                                                        <span class="cd-words-wrapper">
                                                            <span class="item-text is-visible anim_text2" style="color:orange; "><?php echo $data['s1_anim_text2']; ?></span>
                                                            <span class="item-text is-hidden anim_text2" style="color:orange; "><?php echo $data['s1_anim_text2']; ?></span>
                                                        </span>                                          
                                                    </span>
                                                </h1>
                                                <p class="des text-white mb-45 fadeInDown wow"><?php echo $data['s1_text3']; ?>
                                                </p>
                                                <div class="btn-group">
                                                    <a href="#" class="btn-main fadeInDown wow">
                                                        <p class="btn-main-text"><?php echo $data['s1_btn1']; ?></p>
                                                        <p class="iconer">
                                                            <i class="icon-arrow-right"></i>
                                                        </p>
                                                    </a>
                                                    <a href="#" class="btn-w-wa fadeInDown wow"><?php echo $data['s1_btn2']; ?><i
                            ...
                            <div class="slider-home1 relative overflow-hidden swiper-slide">
                                <div class="silider-image">
                                    <img src="../destination_activity/img/<?php echo $data['s2_img']; ?>" alt="Image" class="image-slide">
                                    <img src="./assets/images/slide/mask-slide.png" alt="Image" class="mask-slide">
                                    <img src="./assets/images/slide/mask-fly.png" alt="Image" class="mask-flane">
                                    <div class="booking-title tf-anime-rorate">
                                        <p class="booking"><?php echo $data['s2_squre_box_text']; ?></p>
                                        <span></span>
                                    </div>
                                </div>
                                <div class="slider-content">
                                    <div class="tf-container">
                                        <div class="row">
                                            <div class="col-lg-8">
                                                <span
                                                    class="sub-title text-main font-yes fs-28-46 fadeInDown wow" style="font-size: 70px;" >Hello <?php echo $lead_data['name']; ?></span>
                                                <h1 class="title-slide text-white mb-32 fadeInDown wow"><?php echo $data['s2_text1']; ?><br>
                                                    <span class="animationtext clip text-main">
                                                        <span class="cd-words-wrapper">
                                                            <span class="item-text is-visible anim_text2" style="color:orange; "><?php echo $data['s2_anim_text2']; ?></span>
                                                            <span class="item-text is-hidden anim_text2" style="color:orange; "><?php echo $data['s2_anim_text2']; ?></span>
                                                        </span>                                          
                                                    </span>
                                                </h1>
                                                <p class="des text-white mb-45 fadeInDown wow"><?php echo $data['s2_text3']; ?>
                                                </p>
                                                <div class="btn-group">
                                                    <a href="#" class="btn-main fadeInDown wow">
                                                        <p class="btn-main-text"><?php echo $data['s2_btn1']; ?></p>
                                                        <p class="iconer">
                                                            <i class="icon-arrow-right"></i>
                                                        </p>
                                                    </a>
                                                    <a href="#" class="btn-w-wa fadeInDown wow"><?php echo $data['s2_btn2']; ?><i
                                                            class="icon-Group-13"></i></a>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="slider-home1 relative overflow-hidden swiper-slide">
                                <div class="silider-image">
                                    <img src="../destination_activity/img/<?php echo $data['s3_img']; ?>" alt="Image" class="image-slide">
                                    <img src="./assets/images/slide/mask-slide.png" alt="Image" class="mask-slide">
                                    <img src="./assets/images/slide/mask-fly.png" alt="Image" class="mask-flane">
                                    <div class="booking-title tf-anime-rorate">
                                        <p class="booking"><?php echo $data['s3_squre_box_text']; ?></p>
                                        <span></span>
                                    </div>
                                </div>
                                <div class="slider-content">
                                    <div class="tf-container">
                                        <div class="row">
                                            <div class="col-lg-8">
                                                <span
                                                    class="sub-title text-main font-yes fs-28-46 fadeInDown wow" style="font-size: 70px;" >Hello <?php echo $lead_data['name']; ?></span>
                                                <h1 class="title-slide text-white mb-32 fadeInDown wow"><?php echo $data['s3_text1']; ?><br>
                                                    <span class="animationtext clip text-main">
                                                        <span class="cd-words-wrapper">
                                                            <span class="item-text is-visible anim_text2" style="color:orange;"><?php echo $data['s3_anim_text2']; ?></span>
                                                            <span class="item-text is-hidden anim_text2" style="color:orange; "><?php echo $data['s3_anim_text2']; ?></span>
                                                        </span>                                          
                                                    </span>
                                                </h1>
                                                <p class="des text-white mb-45 fadeInDown wow"><?php echo $data['s3_text3']; ?>
                                                </p>
                                                <div class="btn-group">
                                                    <a href="#" class="btn-main fadeInDown wow">
                                                        <p class="btn-main-text"><?php echo $data['s3_btn1']; ?></p>
                                                        <p class="iconer">
                                                            <i class="icon-arrow-right"></i>
                                                        </p>
                                                    </a>
                                                    <a href="#" class="btn-w-wa fadeInDown wow"><?php echo $data['s3_btn2']; ?><i
                                                            class="icon-Group-13"></i></a>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="travel-video relative">
                                    ...
                                    <div class="video-wrap">
                                        <?php 
                                        if ($data_2['exp_media_link']) {
                                         ?>
                                        <a href="<?php echo $data_2['exp_media_link'];  ?>"
                            ...
                            <div class="col-lg-6">
                                <div class="inner-content-about">
                                    <!-- <span class="sub-title-heading text-main mb-15 fadeInUp wow">Explore the
                                        world</span> -->
                                    <h2 class="title-heading mb-18 fadeInUp wow">For Great Experience <span
                                            class="text-gray font-yes" style="color: green;">Travel </span> <span style="color: green;">&nbsp;with Carrnival Trips</span> </h2>
                                    <p class="des-heading fadeInUp wow mb-5"><?php echo $data_2['exp_details']; ?></p>
                                        ...
                                        <!-- <div class="row mt-27 fadeInUp wow">
                                                <div class="col-sm-6">
                                                    <div class="icon-box-style3">
                                                        ...
                                                        <h6 class="title mb-10"><a href="#">Curated Itinerary</a></h6>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="icon-box-style3">
                                                        ...
                                                        <h6 class="title mb-10"><a href="#">Quick Response</a></h6>
                                                        <p class="des">Welcome to our Print 128 wesit! company that offers a
                                                            wide r</p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row mt-27 fadeInUp wow">
                                                <div class="col-sm-6">
                                                    <div class="icon-box-style3">
                                                        ...
                                                        <h6 class="title mb-10"><a href="#">In-house on ground team</a></h6>
                                                        <p class="des">Welcome to our Print 128 wesit! company that offers a
                                                            wide r</p>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="icon-box-style3">
                                                        ...
                                                        <h6 class="title mb-10"><a href="#">Quality Assurance</a></h6>
                                                        <p class="des">Welcome to our Print 128 wesit! company that offers a
                                                            wide r</p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row mt-27 fadeInUp wow">
                                                <div class="col-sm-6">
                                                    <div class="icon-box-style3">
                                                        ...
                                                        <h6 class="title mb-10"><a href="#">Pre-Purchased Inventory</a></h6>
                                                        <p class="des">Welcome to our Print 128 wesit! company that offers a
                                                            wide r</p>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="icon-box-style3">
                                                        ...
                                                        <h6 class="title mb-10"><a href="#">Dedicated Support Team</a></h6>
                                                        <p class="des">Welcome to our Print 128 wesit! company that offers a
                                                            wide r</p>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 ">
                                            <div class="cheackmark flex mb-50">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <h5 class="mb-15 wow fadeInUp animated"><a href="#"> <?php 
                                        if ($data_2['exp_p1_heading']) {
                                         ?>
                                        <?php echo $data_2['exp_p1_heading']; ?>
                                        <?php }else{ ?>
                                        Curated Itinerary
                                        <?php } ?></a></h5>
                                                    <p class="des wow fadeInUp animated"><?php echo $data_2['exp_p1_details']; ?> </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 ">
                                            <div class="cheackmark flex mb-50">
                                                ...
                                                <div class="content">
                                                    <h5 class="mb-15 wow fadeInUp animated"><a href="#"> <?php 
                                        if ($data_2['exp_p2_heading']) {
                                         ?>
                                        <?php echo $data_2['exp_p2_heading']; ?>
                                        <?php }else{ ?>
                                        Curated Itinerary
                                        <?php } ?></a></h5>
                                                    <p class="des wow fadeInUp animated"><?php echo $data_2['exp_p2_details']; ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 ">
                                            <div class="cheackmark flex mb-50">
                                                ...
                                                <div class="content">
                                                    <h5 class="mb-15 wow fadeInUp animated"><a href="#"> <?php 
                                        if ($data_2['exp_p3_heading']) {
                                         ?>
                                        <?php echo $data_2['exp_p3_heading']; ?>
                                        <?php }else{ ?>
                                        Curated Itinerary
                                        <?php } ?></a></h5>
                                                    <p class="des wow fadeInUp animated"><?php echo $data_2['exp_p3_details']; ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 ">
                                            <div class="cheackmark flex mb-50">
                                                ...
                                                <div class="content">
                                                    <h5 class="mb-15 wow fadeInUp animated"><a href="#"> <?php 
                                        if ($data_2['exp_p4_heading']) {
                                         ?>
                                        <?php echo $data_2['exp_p4_heading']; ?>
                                        <?php }else{ ?>
                                        Curated Itinerary
                                        <?php } ?></a></h5>
                                                    <p class="des wow fadeInUp animated"><?php echo $data_2['exp_p4_details']; ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 ">
                                            <div class="cheackmark flex mb-50">
                                                ...
                                                <div class="content">
                                                    <h5 class="mb-15 wow fadeInUp animated"><a href="#"> <?php 
                                        if ($data_2['exp_p5_heading']) {
                                         ?>
                                        <?php echo $data_2['exp_p5_heading']; ?>
                                        <?php }else{ ?>
                                        Curated Itinerary
                                        <?php } ?></a></h5>
                                                    <p class="des wow fadeInUp animated"><?php echo $data_2['exp_p5_details']; ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 ">
                                            <div class="cheackmark flex ">
                                                ...
                                                <div class="content">
                                                    <h5 class="mb-15 wow fadeInUp animated"><a href="#"> <?php 
                                        if ($data_2['exp_p6_heading']) {
                                         ?>
                                        <?php echo $data_2['exp_p6_heading']; ?>
                                        <?php }else{ ?>
                                        Curated Itinerary
                                        <?php } ?></a></h5>
                                                    <p class="des wow fadeInUp animated"><?php echo $data_2['exp_p6_details']; ?></p>
                                                </div>
                                            </div>
                                        </div>
                ...
                <!-- slide 3.2/ tab -->
                <section class="relative tf-widget-activities overflow-hidden tour-package" >
                    <div class="  w-1456">
                                ...
                                <!-- <div class="col-lg-12 mb-50">
                                        <span
                                            class="sub-title-heading text-main font-yes fs-28-46 wow fadeInUp animated">Explore
                                                                        the
                                                                        world</span>
                                        <h2 class="title-heading wow fadeInUp animated"><?php // echo $lead_data['name']; ?>, This is your Day Wise best plans</h2>
                                </div> -->
                                    ...
                                    <div class="col-lg-12">
                                        <div class="center m0-auto w-text-heading">
                                            <!-- <span class="sub-title-heading text-main mb-15 wow fadeInUp animated">Explore the
                                                world</span> -->
                                            <h2 class="title-heading mb-32 fadeInUp wow" style="color:green; font-size:30px"><?php echo $lead_data['name']; ?>, This is your<span
                                                    class="text-gray font-yes " style="color: blue;"> Day Wise</span> best plans</h2>
                                        </div>
                                    </div>
                                </div>

                                <div class="col-lg-12 pb-5 tab-tour-list">
                                    <ul class="nav  justify-content-center tab-list " id="myTablist"
                                        role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active " id="home-tab" data-bs-toggle="tab"
                                                data-bs-target="#home-tab-pane" type="button" role="tab"
                                                aria-controls="home-tab-pane" aria-selected="true" style="margin:2px; padding:  30px 10px; border-radius: 5px;">
                                        ...
                                        <li class="nav-item" role="presentation" >
                                            <button class="nav-link " id="profile-tab" data-bs-toggle="tab"
                                                ...
                                                aria-controls="profile-tab-pane" aria-selected="false" style="margin:2px; padding:  30px 10px; border-radius: 5px;">
                                                <!-- <span class="icon flex-five">
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="contact-tab" data-bs-toggle="tab"
                                                ...
                                                aria-controls="contact-tab-pane" aria-selected="false" style="margin:2px; padding: 30px 10px; border-radius: 5px;">
                                                <!-- <span class="icon flex-five">
                                    ...
                                    <div class="tab-content mt-44" id="myTabContents">
                                             ...
                                             <!-- Widget Faq -->
                                            <section class="widget-faq  tab-pane fade show active" id="home-tab-pane" role="tabpanel"
                                                                ...
                                                                <div class="content-faq">
                                                                    <!-- <div class="mb-50">
                                                                        <span
                                                                            ...
                                                                            the
                                                                            world</span>
                                                                        <h2 class="title-heading wow fadeInUp animated">Tushar, This is your Day Wise best plans</h2>
                                                                    </div> -->
                                                                    <div class="accordion faq-list" id="accordionExample" >
                                                                        <div class="accordion-item " >
                                                                            ...
                                                                            <div id="collapseOne" class="accordion-collapse collapse relative show information-content-tour pb-3"
                                                                                data-bs-parent="#accordionExample">


                                                                                <div class="row  pb-3 itinerary_ph_view">
                                                                                             <?php
                                                                                    $daywise_1_img=mysqli_query($conn,"Select * from carrnivaltrips_lead_itinerary_sightseeing_img where lead_id='".$lead_data['id'] ."' AND day_no='1' limit 3");
                                                                                    $cnt=1;
                                                                                    $row3_1_img=mysqli_num_rows($daywise_1_img);
                                                                                    ...
                                                                                    if($row3_1_img>0)
                                                                                     {
                                                                                        while ($row3_1_1=mysqli_fetch_assoc($daywise_1_img)) 
                                                                                        {
                                                                                    ...
                                                                                    <img  src="../sightseeing/sightseeing_img/<?php echo $row3_1_1['name'] ?>" style=""  class=" responsive itinerary_ph_img img-fluid" >
                                                                                    </div>
                                                                            ...
                                                                            <?php
                                                                            $daywise_1=mysqli_query($conn,"Select * from carrnivaltrips_lead_itinerary where lead_id='".$lead_data['id'] ."' AND day_no='1' order by id");
                                                                            $cnt=1;
                                                                            $row3_1=mysqli_num_rows($daywise_1);
                                                                            ...
                                                                            if($row3_1>0)
                                                                             {
                                                                                  while ($row3_1=mysqli_fetch_array($daywise_1)) 
                                                                                 {
                                                                            ?>

                                                                                <div class="accordion-body px-4 pb-3" style="">
                                                                                    <ul class="listing-clude">
                                                                                        <li class="flex-three">
                                                                                            
                                                                                           
                                                                                              <p> <i class="icon-Vector-7" style="color:green; margin-right: 10px;"></i> <strong><?php echo $row3_1['name']; ?></strong>- <?php echo $row3_1['description']; ?></p>
                                                                                        </li>
                                                                                    </ul>
                                                                                     <?php // echo $row3_1['name']; ?>
                                                                                </div>
                                                                                <div class="icon"></div>
                                                                         ...
                                                                         ?> 
                                                                            ...
                                                                            <?php   
                                                                                ...
                                                                                if($lead_data['no_of_day'] > 0)
                                                                                {
                                                                                    for ($i=2; $i <= $lead_data['no_of_day'] ; $i++) { 
                                                                                ?> 
                                                                        ...
                                                                        <div class="accordion-item ">
                                                                            ...
                                                                            <div id="collapse<?php echo $i; ?>" class="accordion-collapse relative collapse"
                                                                                data-bs-parent="#accordionExample">


                                                                                <div class="row  pb-3 itinerary_ph_view">
                                                                                             <?php
                                                                                    $daywise_2_img=mysqli_query($conn,"Select * from carrnivaltrips_lead_itinerary_sightseeing_img where lead_id='".$lead_data['id'] ."' AND day_no='$i' limit 3");
                                                                                    $cnt=1;
                                                                                    $row3_2_img=mysqli_num_rows($daywise_2_img);
                                                                                    ...
                                                                                    if($row3_2_img>0)
                                                                                     {
                                                                                        while ($row3_2_img=mysqli_fetch_assoc($daywise_2_img)) 
                                                                                        {
                                                                                    ...
                                                                                    ?>
                                                                                      ...
                                                                                      <div class="col-4 px-0" >
                                                                                    <img  src="../sightseeing/sightseeing_img/<?php echo $row3_2_img['name'] ?>" style=""  class=" responsive itinerary_ph_img img-fluid" >
                                                                                    </div>
                                                                            ...
                                                                            <?php
                                                                            $daywise_2=mysqli_query($conn,"Select * from carrnivaltrips_lead_itinerary where lead_id='".$lead_data['id'] ."' AND day_no='$i' order by id");
                                                                            $cnt=1;


                                                                            $row3_2=mysqli_num_rows($daywise_2);
                                                                            ...
                                                                            if($row3_2>0)
                                                                             {
                                                                                  while ($row3_2=mysqli_fetch_array($daywise_2)) 
                                                                                 {
                                                                            ?>
                                                                                ...
                                                                                <div class="accordion-body px-4 pb-3">
                                                                                    <ul class="listing-clude">
                                                                                        <li class="flex-three mb-1">
                                                                                            
                                                                                            <p> <i class="icon-Vector-7" style="color:green; margin-right: 10px;"></i> <strong><?php echo $row3_2['name']; ?></strong>- <?php echo $row3_2['description']; ?></p>
                                                                                        </li>
                                                                                    </ul>
                                                                                    <?php //echo $row3_2['name']; ?>
                                                                                </div>
                                                                                <div class="icon"></div>
                                            ...
                                            <section class="widget-faq tab-pane fade profile-dashboard " id="profile-tab-pane" role="tabpanel"
                                            aria-labelledby="profile-tab" tabindex="0" >

                                                 <div class="infomation-dashboard mb-40 tf-container p-5" style="background-color: white; border-radius: 10px;">
                                                        <!-- <h4 class="title">Inclusion Information</h4> -->
                                                        <div class="row">
                                                        <div class="col-md-12">

                                                                <div class="widget-dash-board  mb-3">
                                                                        <h4 class="title-add-tour mb-30">All Inclusion</h4>
                                                                        <div class="row mb-30">

                                                                            <?php
                                                                            $inclusion=mysqli_query($conn,"Select * from carrrnivaltrips_package_inclusion where package_id='".$data['id'] ."' order by rank_1");
                                                                            $cnt=1;
                                                                            $row3_2_1=mysqli_num_rows($inclusion);
                                                                            ...
                                                                            if($row3_2_1>0)
                                                                             {
                                                                                  while ($row3_2_1=mysqli_fetch_array($inclusion)) 
                                                                                 {
                                                                            ?>

                                                                            <div class="col-lg-6">
                                                                                <div class="checkbox">
                                                                                    <input id="check<?php echo $row3_2_1['id'] ?>" type="checkbox" name="check" value="<?php echo $row3_2_1['name'] ?>" checked>
                                                                                    <label for="check<?php echo $row3_2_1['id'] ?>"><?php echo $row3_2_1['name'] ?></label>
                                                                                </div>                                                   
                                                                            </div>
                                                                        <?php 
                                                                        }}
                                            ...
                                            <section class="widget-faq tab-pane fade profile-dashboard" id="contact-tab-pane" role="tabpanel"
                                            aria-labelledby="contact-tab" tabindex="0" >
                                                 ...
                                                 <div class="infomation-dashboard mb-40 tf-container p-5" style="background-color: white; border-radius: 10px;">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="widget-dash-board  mb-3">
                                                                    <h4 class="title-add-tour mb-30">All Exclusion</h4>
                                                                    <div class="row mb-30">

                                                                         <?php
                                                                            $exclusion=mysqli_query($conn,"Select * from carrrnivaltrips_package_exclusion where package_id='".$data['id'] ."' order by rank_1");
                                                                            $cnt=1;
                                                                            $row3_3_1=mysqli_num_rows($exclusion);
                                                                            ...
                                                                            if($row3_3_1>0)
                                                                             {
                                                                                  while ($row3_3_1=mysqli_fetch_array($exclusion)) 
                                                                                 {
                                                                            ?>

                                                                            <div class="col-lg-6">
                                                                                <div class="checkbox">
                                                                                    <!-- <input id="check<?php echo $row3_3_1['id'] ?>" type="checkbox" name="check" value="<?php echo $row3_3_1['name'] ?>"> -->
                                                                                    <label for="check<?php echo $row3_3_1['id'] ?>">
                                                                                        <i class="material-icons mb-2" style="font-size:16px;color:red; margin-right: 5px">&#xe5c9;</i>
                                                                                        <?php echo $row3_3_1['name'] ?></label>
                                                                                </div>                                                   
                                                                            </div>
                                                                        <?php 
                                                                        }}
                 ...
                 <!-- slide 4 -->
                 <!-- Widget destination -->
                <section class="widget-destination p_t-20">
                    ...
                    <div class="tf-container">
                        ...
                        <div class="row">
                            ...
                            <!-- <div class="col-lg-12 mb-60">
                                <div class="clip-text">Activity</div>
                            </div> -->
                            ...
                            <div class="col-lg-12">
                                <div class="center m0-auto w-text-heading mb-40">
                                    ...
                                    <h2 class="title-heading fadeInUp wow"><span style="color: green;"><?php echo $lead_data['destination']; ?></span> Activity</h2>
                                </div>
                            </div>


                        </div>
                        <div class="grid-three-destination mb-30" >

                             <?php
                                $activity=mysqli_query($conn,"Select * from carrrnivaltrips_destination_activities where destination='".$data['destination'] ."' order by rank_1 ");
                                $cnt=1;
                                $row3=mysqli_num_rows($activity);
                            ...
                            <?php  
                                if($row3>0)
                                 {
                                      while ($row3=mysqli_fetch_array($activity)) 
                                     {
                            ?>


                                    <div class="tf-widget-destination wow fadeInUp animated timeline_data" data-wow-delay="0.1s" style="margin-top: -15px;" data-name="<?php echo $row3['name'] ?>">
                                        <a  class="destination-imgae" style="border-radius: 20px;" >
                                            <?php if($row3['discount']) {?>
                                            <span class="tour">
                                                -<?php echo $row3['discount'] ?>%
                                            </span>
                                            <?php } ?>
                                                            
                                            <img class="rounded" src="../destination_activity/activities_img/<?php echo $row3['img'] ?>" alt="" style="height: 270px; " >
                                        </a>
                                        <div class="destination-content"  >
                                            <span class="nation"><?php echo $row3['name'] ?> </span>
                                            <span class="title" style="font-weight: bold; padding-left: 15px;">Rs.<?php echo $row3['price'] ?></span>
                                            <div class="flex-two btn-destination">
                                                <!-- <h6 class="title"><a href="#">View all Activity</a></h6> -->
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="center m0-auto w-text-heading">
                                    <!-- <span class="sub-title-heading text-main mb-15 fadeInUp wow">Explore the
                                        world</span> -->
                                    <h2 class="title-heading mb-40 fadeInUp wow">Special Experiences At<!-- <span
                                            class="text-gray font-yes">At</span> --> <span style="color: green;"><?php echo $lead_data['destination']; ?></span></h2>
                                </div>
                            ...
                            <?php
                                $activity_4=mysqli_query($conn,"Select * from carrrnivaltrips_destination_special_experiences where destination='".$data['destination'] ."'  order by rank_1");
                                $cnt=1;
                                $row4=mysqli_num_rows($activity_4);
                            ...
                            <?php  
                                if($row4>0)
                                 {
                                      while ($row4=mysqli_fetch_array($activity_4)) 
                                     {
                            ?>

                                                <div class="col-sm-6 col-lg-3">
                                                    <div class="tour-listing wow fadeInUp animated timeline_data"
                                                        data-wow-delay="0.1s" data-name="<?php echo $row4['name'] ?>" >
                                                        <a  class="tour-listing-image">
                                                            <div class="badge-top flex-two">
                                                                 <?php if($row4['discount']) {?>
                                                                <span class="feature">
                                                            ...
                                                            <img src="../destination_activity/activities_img/<?php echo $row4['img'] ?>"
                                                                alt="Image Listing" style="height: 250px;" >

                                                        </a>
                                                        <div class="tour-listing-content">
                                                            <span class="tag-listing">Bestseller</span>

                                                            <span class="map"><i class="icon-Vector4"></i><?php echo $lead_data['destination']; ?></span>
                                                            <h3 class="title-tour-list"><a href="#"><?php echo $row4['name'] ?></a>
                                                            </h3>
                                                            <!-- <div class="review">
                                                                <i class="icon-Star"></i>
                                                                <i class="icon-Star"></i>
                                                            ...
                                                            <div class="flex-two">
                                                                <div class="price-box flex-three">
                                                                    <p><span class="price-sale">Rs.<?php echo $row4['price'] ?></span></p>
                                                                    <!-- <span class="price">Rs.<?php echo $row4['price'] ?></span> -->
                                                                </div>
                ...
                <!-- slide 6 -->
                 <!-- Widget Tour-select -->
                <!-- <section class="tour-select mb-60 mt-5">
                    <div class="tf-container">
                        <div class="row">
                            <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="box-tour-select-wrap mb--7em">
                                    <a href="#" class="box-tour-select-item center wow fadeInUp animated "
                                        data-wow-delay="0.1s">
                                        <div class="icon">
                                            <i class="icon-tent-1"></i>
                                        </div>
                                        <div class="content relative">
                                            <div class="title"><?php if($data_2['payment_policy1']){ ?>
                                            <?php echo $data_2['payment_policy1']; ?>
                                        <?php }else{ ?>   
                                        Flexible Payment Policy
                                        <?php } ?></div>
                                           
                                            <i class="icon-Group-1000002950"></i>
                                        </div>
                                    </a>
                                    <a href="#" class="box-tour-select-item center wow fadeInUp animated "
                                        data-wow-delay="0.2s">
                                        <div class="icon">
                                            <i class="icon-sunset-1"></i>
                                        </div>
                                        <div class="content relative">
                                            <div class="title"><?php if($data_2['payment_policy2']){ ?>
                                            <?php echo $data_2['payment_policy2']; ?>
                                        <?php }else{ ?>   
                                        Flexible Cancellation Charges
                                        <?php } ?>
                                            </div>
                                    ...
                                    <a href="#" class="box-tour-select-item center wow fadeInUp animated "
                                        ...
                                        <div class="content relative">
                                            <div class="title"><?php if($data_2['payment_policy3']){ ?>
                                            <?php echo $data_2['payment_policy3']; ?>
                                        <?php }else{ ?>   
                                    ...
                                    <a href="#" class="box-tour-select-item center wow fadeInUp animated "
                                        ...
                                        <div class="content relative">
                                            <div class="title"><?php if($data_2['payment_policy4']){ ?>
                                            <?php echo $data_2['payment_policy4']; ?>
                                        <?php }else{ ?>   
                                    ...
                                    <a href="#" class="box-tour-select-item center wow fadeInUp animated "
                                        ...
                                        <div class="content relative">
                                            <div class="title"><?php if($data_2['payment_policy5']){ ?>
                                            <?php echo $data_2['payment_policy5']; ?>
                                        <?php }else{ ?>   
                                        Easy EMI/Finance Option at 0% for 06 Months
                                        <?php } ?>
                                    </div>
                ...
                <section class="widget-faq py-2">
                    <div class="tf-container">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-30 center">
                                    <!-- <span
                                        class="sub-title-heading text-second font-yes fs-28-46 wow fadeInUp animated">Explore
                                        the
                                        world</span> -->
                                    <h2 class="title-heading wow fadeInUp animated">
                                        Payment Policy
                                     <!-- <span   class="booking-title"><span class="booking">Select<span class="dot"></span></span></span> By Type -->
                                    </h2>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="content-faq">
                                    ...
                                    <div class="accordion faq-list" id="accordionExample_2">
                                        <div class="accordion-item">
                                            <h2 class="accordion-header">
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                    data-bs-target="#collapseOne" aria-expanded="true"
                                                    aria-controls="collapseOne">
                                                    <?php if($data_2['payment_policy1']) {?>
                                            <?php echo $data_2['payment_policy1']; ?>                                            
                                        <?php }else{ ?>
                                            Flexible Payment Policy
                                        <?php } ?>
                                            ...
                                            <div id="collapseOne" class="accordion-collapse collapse relative show"
                                                ...
                                                <div class="accordion-body">
                                                    <?php echo $data_2['why_carrnival_description1']; ?>
                                                </div>
                                                <div class="icon"></div>
                                            </div>
                                        </div>
                                        ...
                                        <?php } ?>
                                            ...
                                            <div id="collapseTwo" class="accordion-collapse relative collapse"
                                                data-bs-parent="#accordionExample_2">
                                                <div class="accordion-body">
                                                    <?php echo $data_2['why_carrnival_description2']; ?>
                                                </div>
                                                <div class="icon"></div>
                                            </div>
                                        </div>
                                        ...
                                        <?php } ?>
                                            ...
                                            <div id="collapseThree" class="accordion-collapse relative collapse"
                                                data-bs-parent="#accordionExample_2">
                                                <div class="accordion-body">
                                                   <?php echo $data_2['why_carrnival_description3']; ?>
                                                </div>
                                                <div class="icon"></div>
                                            </div>
                                        </div>
                                        ...
                                        <?php } ?>
                                            ...
                                            <div id="collapseThree_1" class="accordion-collapse relative collapse"
                                                data-bs-parent="#accordionExample_2">
                                                <div class="accordion-body">
                                                    <?php echo $data_2['why_carrnival_description4']; ?>
                                                </div>
                                                <div class="icon"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="accordion-item">
                                            <h2 class="accordion-header">
                                                <button class="accordion-button collapsed" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#collapseThree_2"
                                                    aria-expanded="false" aria-controls="collapseThree_2">
                                                    <?php if($data_2['payment_policy5']) {?>
                                            <?php echo $data_2['payment_policy5']; ?>                                            
                                        <?php }else{ ?>
                                            Easy EMI/Finance Option at 0% for 06 Months
                                        <?php } ?>
                                            ...
                                            <div id="collapseThree_2" class="accordion-collapse relative collapse"
                                                data-bs-parent="#accordionExample_2">
                                                <div class="accordion-body">
                                                   <?php echo $data_2['why_carrnival_description5']; ?>
                                                </div>
                                                <div class="icon"></div>
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="center m0-auto w-text-heading">
                                    <!-- <span class="sub-title-heading text-main mb-15 wow fadeInUp animated">Explore the
                                        world</span> -->
                                    <h2 class="title-heading mb-40 wow fadeInUp animated">Best Scenic Places Of<!-- <span
                                            class="text-gray font-yes">of</span> --> <span style="color: green;"><?php echo $lead_data['destination']; ?></span></h2>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                             ...
                             <?php
                                $activity_7=mysqli_query($conn,"Select * from carrrnivaltrips_destination_best_scenic_places where destination='".$data['destination'] ."' order by rank_1");
                                $cnt=1;
                                $row7=mysqli_num_rows($activity_7);
                            ...
                            <?php  
                                if($row7>0)
                                 {
                                      while ($row7=mysqli_fetch_array($activity_7)) 
                                     {
                            ?>


                            <div class="col-md-4 wow fadeInUp animated mb-2 timeline_data" data-wow-delay="0.1s" data-name="<?php echo $row7['name'] ?>">
                                <div class="tf-widget-blog blog-style" style="border-radius: 10px;">
                                    <a  class="blog-image" style="border-radius: 10px;">
                                        <img src="../destination_activity/activities_img/<?php echo $row7['img'] ?>" alt="" style="height: 270px;">
                                        <div class="category-blog">
                                            

                                             <?php if($row7['discount']) {?>
                                                    <i class="icon-Group-8"></i>
                                                <span class="feature">
                                                     -<?php echo $row7['discount'] ?>%
                                                </span>
                                            <?php } ?>
                                    ...
                                    <div class="blog-content" style="box-shadow: 1px 1px 3px #E0E0E0; border-radius: 5px;">
                                        ...
                                        <h3 class="entry-title"><a href="#"><?php echo $row7['name'] ?></a></h3>
                                        <!-- <p class="des">Beach is famous for swimming amongst all age groups in the area..
                                        </p> -->
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="center m0-auto w-text-heading">
                                   <!--  <span class="sub-title-heading text-main mb-15 fadeInUp wow">Explore the
                                        world</span> -->
                                    <h2 class="title-heading mb-40 fadeInUp wow">Adventure Activities At<!-- <span
                                            class="text-gray font-yes">At</span> --> <span style="color: green;"><?php echo $lead_data['destination']; ?></span></h2>
                                </div>
                                <div class="tab-tour-list">
                            ...
                            <?php
                                $activity_8=mysqli_query($conn,"Select * from carrrnivaltrips_destination_adventure_activities where destination='".$data['destination'] ."' order by rank_1");
                                $cnt=1;
                                $row8=mysqli_num_rows($activity_8);
                            ...
                            <?php  
                                if($row8>0)
                                 {
                                      while ($row8=mysqli_fetch_array($activity_8)) 
                                     {
                            ?>

                                                <div class="col-sm-6 col-lg-3">
                                                    <div class="tour-listing wow fadeInUp animated timeline_data"
                                                        data-wow-delay="0.1s" data-name="<?php echo $row8['name'] ?>">
                                                        <a  class="tour-listing-image">
                                                            <div class="badge-top flex-two">
                                                                <!-- <span class="feature">Adventure</span> -->
                                                                 <?php if($row8['discount']) {?>
                                                                <span class="feature">
                                                                    -<?php echo $row8['discount'] ?>%
                                                                </span>
                                                                <?php } ?>
                                                                <!-- <div class="badge-media flex-five">
                                                                    <span class="media"><i
                                                            ...
                                                            <img src="../destination_activity/activities_img/<?php echo $row8['img'] ?>"
                                                                alt="Image Listing" style="height: 250px;" >

                                                        </a>
                                                        <div class="tour-listing-content">
                                                            <span class="tag-listing">Bestseller</span>
                                                            <span class="map"><i class="icon-Vector4"></i>Andaman</span>
                                                            <h3 class="title-tour-list"><a href="#"><?php echo $row8['name'] ?></a>
                                                            </h3>
                                                            <!-- <div class="review">
                                                                <i class="icon-Star"></i>
                                                                <i class="icon-Star"></i>
                                                            ...
                                                            <div class="flex-two">
                                                                <div class="price-box flex-three">
                                                                    <p>From <span class="price-sale">Rs.<?php echo $row8['price'] ?></span></p>
                                                                    <span class="price">Rs.<?php echo $row8['price'] ?></span>
                                                                </div>
                                                                <!-- <div class="icon-bookmark">
                                                                    <i class="icon-Vector-151"></i>
                                                                </div> -->
                            ...
                            <div class="col-lg-7 content-banner-contact">
                                <div class="mb-32">
                                    <!-- <span
                                        ...
                                        the
                                        world</span> -->
                                    <h2 class="title-heading text-white wow fadeInUp animated">Hi <?php echo $lead_data['name']; ?>, I am <?php if($data_2['contact_person']) {?><?php echo $data_2['contact_person']; ?><?php }else{ ?>Richa <?php } ?><br><?php if($data_2['contact_text']) {?><?php echo $data_2['contact_text']; ?><?php }else{ ?>NEED MORE CUSTOMIZATION CONNECT WITH OUR DESTINATION EXPERT <?php } ?></h2>
                                </div>
                                <div class="flex-three">
                                    <div class="video-wrap wow fadeInUp animated">
                                        <?php if($data_2['contact_media_link']) {?><a href="<?php echo $data_2['contact_media_link']; ?>"
                                            class="widget-icon-video flex-five widget-videos">
                                            <i class="icon-Polygon-4"></i>
                                        </a><?php }else{ ?><a href="https://www.youtube.com/watch?v=n9LgeoJE4EI"
                                            class="widget-icon-video flex-five widget-videos">
                                            <i class="icon-Polygon-4"></i>
                                        </a> <?php } ?>
                                        
                                    </div>
                                    <address class="wow fadeInUp animated d-flex align-center">
                                        
                                        <!-- <a href="mailto:@Hooktheme.co"> @Hooktheme.co</a> -->
                                         <?php if($data_2['contact_ph']) {?>
                                            <i class="fa fa-phone" style="font-size:38px;color:green; "></i>
                                        <a href="tel:+91 <?php echo $data_2['contact_ph']; ?>">
                                        &nbsp;&nbsp;&nbsp;Contact us at &nbsp;+91<?php echo $data_2['contact_ph']; ?></a><br>
                                        <?php }else{ ?>
                                            <i class="fa fa-phone" style="font-size:38px;color:green; "></i>
                                        <a href="tel:+91 9213879313">
                                        &nbsp;&nbsp;&nbsp;Contact us at &nbsp;+91 9213879313</a><br>
                                        <?php } ?>
                ...
                <!-- slide 10 -->
                <!-- Widget Counter -->
                <section class="widget-counter relative  mb-450" style="margin-bottom: 250px;">
                        ...
                        <div class="row mb-50">
                            <div class="col-lg-9 flex-three cta-wrap">
                                ...
                                <div class="content">
                                    <h2 class="title-call text-white mb-18 fadeInUp wow">
                                        <?php if($data_2['achievement_heading']) {?>
                                            <?php echo $data_2['achievement_heading']; ?>                                            
                                        <?php }else{ ?>
                                            Ready to adventure and enjoy natural
                                        <?php } ?>
                                        </h2>
                                     <p class="des text-white fadeInUp wow">
                                        <?php if($data_2['achievement_description']) {?>
                                            <?php echo $data_2['achievement_description']; ?>                                            
                                        <?php }else{ ?>
                            ...
                            <div class="col-lg-3">
                                <div class="callt-to-action-button text-end fadeInRight wow">
                                    <a href="tel:+91 <?php echo $data_2['contact_ph']; ?>" class="get-call">
                                        <?php if($data_2['achievement_btn']) {?>
                                            <?php echo $data_2['achievement_btn']; ?>                                            
                                        <?php }else{ ?>
                                            Let,s get started
                                        <?php } ?>
                                    </a>
                        ...
                        <div class="row mb--20em relative z-index3">
                            <div class="col-6 col-lg-3 wow fadeInUp animated " data-wow-delay="0.1s">
                                <div class="tf-counter center tf-countto">
                                    ...
                                    <div class="number-counter " data-to="<?php echo $data_2['achievement_count1']; ?>" data-speed="2000"
                                        data-waypoint-active="yes"><?php echo $data_2['achievement_count1']; ?></div>
                                    <span class="line"></span>
                                    <p class="title-counter"><?php echo $data_2['achievement_title1']; ?></p>
                                </div>
                            </div>
                            <div class="col-6 col-lg-3 wow fadeInUp animated " data-wow-delay="0.2s">
                                <div class="tf-counter center tf-countto">
                                    ...
                                    <div class="number-counter percen" data-to="<?php echo $data_2['achievement_count2']; ?>" data-speed="2000"
                                        data-waypoint-active="yes"><?php echo $data_2['achievement_count2']; ?>%</div>
                                    <span class="line"></span>
                                    <p class="title-counter"><?php echo $data_2['achievement_title2']; ?></p>
                                </div>
                            </div>
                            <div class="col-6 col-lg-3 wow fadeInUp animated " data-wow-delay="0.3s">
                                <div class="tf-counter center tf-countto">
                                    ...
                                    <div class="number-counter plus" data-to="<?php echo $data_2['achievement_count3']; ?>" data-speed="2000"
                                        data-waypoint-active="yes"><?php echo $data_2['achievement_count3']; ?>+</div>
                                    <span class="line"></span>
                                    <p class="title-counter"><?php echo $data_2['achievement_title3']; ?></p>
                                </div>
                            </div>
                            <div class="col-6 col-lg-3 wow fadeInUp animated " data-wow-delay="0.4s">
                                <div class="tf-counter center tf-countto">
                                    ...
                                    <div class="number-counter " data-to="<?php echo $data_2['achievement_count4']; ?>" data-speed="2000"
                                        data-waypoint-active="yes"><?php echo $data_2['achievement_count4']; ?></div>
                                    <span class="line"></span>
                                    <p class="title-counter"><?php echo $data_2['achievement_title4']; ?></p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="content-faq">
                                    <div class="mb-50">
                                        <!-- <span
                                            ...
                                            world</span> -->
                                        <h2 class="title-heading wow fadeInUp animated">
                                            <?php if($data_2['why_carrnival_heading']) {?>
                                            <?php echo $data_2['why_carrnival_heading']; ?>                                            
                                        <?php }else{ ?>
                                            WHY CARRNIVAL TRIPS
                                        <?php } ?>
                                        </h2>
                                    </div>
                                    <div class="accordion faq-list" id="accordionExample_1">
                                        <div class="accordion-item">
                                            <h2 class="accordion-header">
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                    data-bs-target="#collapseOne" aria-expanded="true"
                                                    aria-controls="collapseOne">
                                                    <?php if($data_2['why_carrnival_title1']) {?>
                                            <?php echo $data_2['why_carrnival_title1']; ?>                                            
                                        <?php }else{ ?>
                                            Bullet points and video
                                        <?php } ?>
                                        ...
                                        <div class="accordion-item">
                                            <h2 class="accordion-header">
                                                <button class="accordion-button collapsed" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#collapseTwo"
                                                    aria-expanded="false" aria-controls="collapseTwo">
                                                    <?php if($data_2['why_carrnival_title2']) {?>
                                            <?php echo $data_2['why_carrnival_title2']; ?>                                            
                                        <?php }else{ ?>
                                            Best planned customised itinerary
                                        <?php } ?>
                                        ...
                                        <div class="accordion-item">
                                            <h2 class="accordion-header">
                                                <button class="accordion-button collapsed" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#collapseThree"
                                                    aria-expanded="false" aria-controls="collapseThree">
                                                    <?php if($data_2['why_carrnival_title3']) {?>
                                            <?php echo $data_2['why_carrnival_title3']; ?>                                            
                                        <?php }else{ ?>
                                            Best in class hotel selection in that segment 
                                        <?php } ?>
                                        ...
                                        <div class="accordion-item">
                                            <h2 class="accordion-header">
                                                <button class="accordion-button collapsed" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#collapseThree_1"
                                                    aria-expanded="false" aria-controls="collapseThree_1">
                                                    <?php if($data_2['why_carrnival_title4']) {?>
                                            <?php echo $data_2['why_carrnival_title4']; ?>                                            
                                        <?php }else{ ?>
                                            Guided Trip
                                        <?php } ?>
                                        ...
                                        <div class="accordion-item">
                                            <h2 class="accordion-header">
                                                <button class="accordion-button collapsed" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#collapseThree_2"
                                                    aria-expanded="false" aria-controls="collapseThree_2">
                                                    <?php if($data_2['why_carrnival_title5']) {?>
                                            <?php echo $data_2['why_carrnival_title5']; ?>                                            
                                        <?php }else{ ?>
                                            No Hidden costs
                                        <?php } ?>
                                        ...
                                        <div class="accordion-item">
                                            <h2 class="accordion-header">
                                                <button class="accordion-button collapsed" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#collapseThree_3"
                                                    aria-expanded="false" aria-controls="collapseThree_3">
                                                    <?php if($data_2['why_carrnival_title6']) {?>
                                            <?php echo $data_2['why_carrnival_title6']; ?>                                            
                                        <?php }else{ ?>
                                            No false promises
                                        <?php } ?>
                                            ...
                                            <div id="collapseThree_3" class="accordion-collapse relative collapse"
                                                data-bs-parent="#accordionExample_1">
                                                <div class="accordion-body">
                                                    <?php echo $data_2['why_carrnival_description6']; ?>
                                                </div>
                                                <div class="icon"></div>
                                            </div>
                                        </div>
                    ...
                    <div class="tf-container">
                        <div class="callt-to-action flex-two">
                            <div class="callt-to-action-content flex-three">
                                ...
                                <div class="content">
                                    <h2 class="title-call">Call now to connect with Counselor for more customisation &nbsp;
                                    <a href="tel:+91 <?php echo $data_2['contact_ph']; ?>" style="color:  white;">+91 <?php echo $data_2['contact_ph']; ?></a></h2>
            ...
            <footer class="footer footer-style1">
                <div class="tf-container">
                        ...
                        <div class="footer-logo">
                            ...
                            <ul class="footer-info">
                                ...
                                <li class="flex-three">
                                    ...
                                    <p><a href="tel:+91 <?php echo $data_2['contact_ph']; ?>" style="color:  white;">+91 <?php echo $data_2['contact_ph']; ?></a>
                    ...
                    <div class="row footer-bottom">
                        <div class="col-md-6">
                            <p class="copy-right">Copyright © 2024 by <a href="#" class="text-main">Code Arjun.</a> All
                                Rights Reserved</p>
                        </div>
                        <!-- <div class="col-md-6">
...
<script type="text/javascript">
    // Output PHP variable for user_id with json_encode to avoid type issues
    
    var user_id = <?php echo json_encode($id); ?>;
    console.log("User ID:", user_id);

    document.addEventListener('DOMContentLoaded', function () {
        // Select all elements with the class 'timeline_data'
        let timeline_data = document.querySelectorAll('.timeline_data');
        
        // Add event listener to each button
        timeline_data.forEach(function (button) {
            button.addEventListener('click', function () {
                let product = this.getAttribute('data-name');
                console.log("Product Clicked:", product);

                // Send the tracked data to the server for logging
                trackClick(product,user_id);
            });
        });

        // Function to send data to the server for logging
        function trackClick(product,user_id) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    try {
                        ...
                        alert(e); // Catch and alert any exceptions
                        // location.reload(); // Still reload after alerting
                    }
                },
                error: function () {
    ...
    <!-- <script type="text/javascript">
            ...
            console.log(user_id);
                ...
                document.addEventListener('DOMContentLoaded', function () {
            // Select all 'timeline_data' buttons
            let timeline_data = document.querySelectorAll('.timeline_data');
            
            // Add event listener to each button
            timeline_data.forEach(function (button) {
                button.addEventListener('click', function () {
                    let product = this.closest('.timeline_data').getAttribute('data-name');
                    console.log("Product  Clicked:", product);
            ...
            function trackClick(product) {
                ...
                //     },
                //     body: JSON.stringify({ product: product, user_id:user_id })
                // })
   ...
   <!--  <script type="text/javascript">
         ...
         function user_timeline(text) {

            var lead_id= <?php // cho $_GET['id'] ?>;
            console.log(lead_id);
            if (confirm(text) == true) {


             $.ajax({
                    url: "lead_sightseeing_point.php",
                    method: "POST",
                    data: {
