 ...
 ?>
  ...
  <?php 
                ...
                if(isset($_GET['id']))
                {
                  ...
                  $eid = $_GET['id'];
                  $row = mysqli_query($conn, "select * from carrnivaltrips_customer where id='$id' ");
...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
		<div class="container">
			<a class="navbar-brand" href="client.php">CarrnivalTrips<span>Travel Agency</span></a>
	...
	<div class="hero-wrap js-fullheight" style="background-image: url('images/bg_5.jpg');">
		...
		<div class="container">
			<div class="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
				<div class="col-md-7 ftco-animate">
					<span class="subheading">Welcome to CarrnivalTrips</span>
					<h1 class="mb-4">Hello <?php echo $data['FirstName']; ?><br>Here is your <?php echo $data['Destination']; ?> Package Details </h1>
			...
			<div class="container">
				<div class="row d-flex">
					<div class="col-md-6 order-md-last heading-section pl-md-5 ftco-animate d-flex align-items-center">
						<div class="w-100">
							<span class="subheading">Welcome to CarrnivalTrips</span>
							<h2 class="mb-4">Thanks for choosing us</h2>
							<p>A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.</p>
							<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.
							A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
							<p><a href="#" class="btn btn-primary py-3 px-4">Emergency Call</a></p>
						</div>
					</div>
			...
			<div class="container">
				<div class="row justify-content-center pb-4">
					<div class="col-md-12 heading-section text-center ftco-animate">
						<span class="subheading">CarrnivalTrips Provide Places</span>
						<h2 class="mb-4"> <?php echo $data['FirstName']; ?>, Here is Your Activities</h2>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="row justify-content-center pb-4">
					<div class="col-md-12 heading-section text-center ftco-animate">
						...
						<h2 class="mb-4">Want More Activities To Explore?</h2>
					</div>
				</div>
				<div class="row">
					<div class="col-md-4 ftco-animate">
						<div class="project-wrap">
							<a href="#" class="img" style="background-image: url(images/destination-1.jpg);">
								<span class="price">Rs.550/person</span>
							</a>
							<div class="text p-4">
								...
								<ul>
									...
									<li><span class="flaticon-mountains"></span><a href="#">Add Activities</a></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="project-wrap">
							...
							<div class="text p-4">
								...
								<ul>
									<li><span class="flaticon-shower"></span>2</li>
									<li><span class="flaticon-king-size"></span>3</li>
									<li><span class="flaticon-sun-umbrella"></span><a href="#">Add Activities</a></li>
								</ul>
							</div>
						</div>
					</div>
		...
		<section class="ftco-section ">
			<div class="container">
				...
				<div class="row justify-content-center pb-4">
					<div class="col-md-12 heading-section text-center ftco-animate">
						<span class="subheading">Day Wise Plan</span>
						<h2 class="mb-4"><?php echo $data['Destination']; ?> Trip</h2>
					</div>
				</div>
				...
				<div class="timeline">
				  <div class="container_1 left">
				    <div class="content">
				      <h2>Day 1</h2>
				      <p>Arrive at Port Blair, check-in, and relax. Visit the Cellular Jail in the afternoon, followed by the light and sound show. Transfer back to the hotel for the night.</p>
				  ...
				  <div class="container_1 right">
				    <div class="content">
				      <h2>Day 2</h2>
				      <p>Travel from Port Blair to Havelock Island by ferry. Check-in and visit Radhanagar Beach, known for its white sand and beautiful sunset. Return to the hotel for the night.</p>
				  ...
				  <div class="container_1 left">
				    <div class="content">
				      <h2>Day 3</h2>
				       <p>Visit Elephant Beach for water sports and relaxation. Return to the hotel for the night, enjoying leisure time.</p>
				  ...
				  <div class="container_1 right">
				    <div class="content">
				      <h2>Day 4</h2>
				      <p><p>Visit Kalapathar Beach. Later, take a ferry back to Port Blair and check in to the hotel. Enjoy your leisure time.</p>
				    </div>
				  </div>
				    ...
				    <div class="container_1 left">
					    <div class="content">
					      <h2>Day 5</h2>
					      <p>Check out and transfer to the airport for your return flight, carrying beautiful memories of the trip.</p>
					    </div>
					 </div>
			...
			<div class="container">
				<div class="row justify-content-center pb-4">
					<div class="col-md-7 text-center heading-section heading-section-white ftco-animate">
						...
						<h2 class="mb-4">Best Places Feedback</h2>
					</div>
				</div>
