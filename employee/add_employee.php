        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="php_action/add_employee.php" method="POST" enctype="multipart/form-data">
                <div class="card-body">


                  <div class="form-group">
                    <label for="Employee_name" >Employee Name</label>
                    <input type="text" class="form-control" id="Employee_name" name="name" placeholder="" required>
                  </div>
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary" value="Submit" name="add_employee">Submit</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
