...
if(isset($_POST['activity_update']))
{
    ...
    if($_POST['package_id']!="") 
    {
        ...
        // Delete data
        $qys = "DELETE FROM carrrnivaltrips_package_best_scenic_places where package_id='".$_POST['package_id']."'";
        ...
        foreach($_POST['name'] as $key=>$value) 
        {
            ...
            $query1="INSERT INTO carrrnivaltrips_package_best_scenic_places (package_id,name, price, img,discount,rank_1 ) VALUES ('".$_POST['package_id']."', '".$_POST['name'][$key]."'  , '".$_POST['price'][$key]."'  ,  '$new_img1', '".$_POST['discount'][$key]."' , '".$_POST['rank_1'][$key]."' )";
                            ...
                            <table class="table table-bordered table-hover" id="dynamic_field">
                                ...
                                <?php
                                      ...
                                      if($_GET['id'] !="")
                                      {
                                        ...
                                        $product = "SELECT * FROM carrrnivaltrips_package_best_scenic_places WHERE  package_id='".$_GET['id']."'";
