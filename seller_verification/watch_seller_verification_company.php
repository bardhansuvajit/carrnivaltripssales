              ...
              <form action="php_action/edit_product.php" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="farmer_name" name="farmer_name" placeholder="Enter Name" value="<?php echo $data['owner_name'] ?>">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="ph_no">district</label>
                    <input type="text" class="form-control" id="ph_no" name="district" placeholder="District" value="<?php echo $data['district'] ?>">
                  </div>
