  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Individual Seller Verification</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item active">Individual Seller Verification</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <?php 
        $selectQuery="Select * from fishfed_seller_ac_individual ";
          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Individual Seller Verification</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-hover table-striped">
                  ...
                  <tbody>
                    ...
                    <?php
                              $product=mysqli_query($conn,"Select * from fishfed_seller_for_verification where  verification_team_id = '".$data['id']."' AND seller_role='individual'");
                            $cnt=1;
                            ...
                            if($row>0)
                            {
                              while ($row=mysqli_fetch_array($product)) 
                              {
                                ...
                                $query1=$conn->query("SELECT * FROM fishfed_seller_ac_individual WHERE id='".$row['seller_id']."'" )  or die("query Failed");
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php  echo $row1['farmer_name'];?></td>
                                    ...
                                    <td>
                                        ...
                                        <a href="edit_seller_verification_individual.php?editid=<?php echo htmlentities($row1['id']);?>" class="edit" title="Update" data-toggle="tooltip"  style="color:green;">Update <i class="fas fa-edit"></i></a> 
                                        <br>
                                         <a href="watch_seller_verification_individual.php?editid=<?php echo htmlentities($row1['id']);?>" class="edit" title="Watch" data-toggle="tooltip"  style="color:green;">Watch <i class="fas fa-edit"></i></a>
