        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <form action="php_action/edit_seller_verification_individual.php" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="img_aadharcard">Aadharcard Image</label>
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="img_aadharcard" name="image2" value="<?php echo $data['img_aadharcard'] ?>">
                        <label class="custom-file-label" for="img_aadharcard" ><?php echo $data['img_aadharcard'] ?>  Choose file</label>
                      </div>
                    </div>
                    <img src="img/<?php echo $data['img_aadharcard'] ?>" alt="Aadharcard Image" width="80" height="80" >
                  </div>
                  ...
                  <div class="form-group">
                    <label for="verify_location" >Verification Location</label><br>
                ...
                <!-- /.card-body -->
                  ...
                  <input type="hidden" class="form-control" id="img2" name="img2"  value="<?php echo $data['img_aadharcard'] ?>">
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary" value="Submit" name="edit_seller_verification_individual">Update</button> 
                </div>
              </form>
