                          ...
                          <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div id="">
                                   ...
                                   <div class="form-check form-check-inline bg-primary  m-1"  style="padding:4px 30px; border-radius:5px" ><input class="form-check-input me-2" id="lead_sightseeing_point_<?php echo $row_2['id'] ; ?>"  type="checkbox" data-filter="lead_sightseeing_point" value="<?php echo $row_2['name'] ; ?>"><label class="form-check-label" for="lead_sightseeing_point_<?php echo $row_2['id'] ; ?>"><?php echo $row_2['name'] ; ?></label></div>
