...
<div class="sidebar-wrapper" data-layout="stroke-svg">
  <div>
    <div class="logo-wrapper "><a href="index.php"><img class="img-fluid" src="assets/images/logo/logo_light.png" alt="" width="120px" height="100px"></a>
      ...
      <nav class="sidebar-main">
              ...
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i> <a class="sidebar-link sidebar-title" href="index.php">
                   ...
                   <!-- <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                      ...
                      </svg><span class="">User Registration</span></a>
                    <ul class="sidebar-submenu">
                      <li><a href="registration/individual_registration.php">Individual Registration</a></li>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                      ...
                      </svg><span>Leads</span></a>
                    <ul class="sidebar-submenu">
                      <li><a href="lead/add_lead.php">Add Lead</a></li>
                      <!-- <li><a href="index.php">Diplay Leads</a></li> -->
                    </ul>
                  </li>
                 ...
                 <!--  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                      ...
                      </svg><span>Trainning Post</span></a>
                    <ul class="sidebar-submenu">
                      <li><a href="training_post/add_training_post.php">Add Trainning Post</a></li>
                      <li><a href="training_post/display_training_post.php">Diplay Trainning Post</a></li>
                    </ul>
                  </li> -->
                ...
                <!--   <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="product/add_product_category.php">Add Product Category</a></li>
                      <li><a href="product/add_product.php">Add Product</a></li>
                      <li><a href="product/display_product.php">Diplay Product</a></li>
                    </ul>
                  </li> -->
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                      ...
                      <svg class="fill-icon">
                        <use href="assets/svg/icon-sprite.svg#fill-blog"></use>
                      </svg><span class="">Seller A/C</span></a>
                    <ul class="sidebar-submenu">
                      <li><a href="seller_ac_registration/individual_seller_ac.php">Individual Seller A/C</a></li>
                      <li><a href="seller_ac_registration/company_seller_ac.php">Company Seller A/C</a></li>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                      ...
                      <svg class="fill-icon">
                        <use href="assets/svg/icon-sprite.svg#fill-blog"></use>
                      </svg><span class="">Seller Product</span></a>
                    <ul class="sidebar-submenu">
                      <li><a href="seller_product/display_individual_seller_product.php">Display Individual Product</a></li>
                      <li><a href="seller_product/display_company_seller_product.php">Display Company Product</a></li>
                   ...
                   <!-- <li class="sidebar-main-title">
                    <div>
                      <h6 class="lan-11">Verification Team</h6>
                    </div>
                  </li> 
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                      ...
                      <svg class="fill-icon">
                        <use href="assets/svg/icon-sprite.svg#fill-blog"></use>
                      </svg><span class="">Verification Team</span></a>
                    <ul class="sidebar-submenu">
                      <li><a href="verification_team/add_verification_team.php">Add Varification Person</a></li>
                      <li><a href="verification_team/display_verification_team.php">Display Varification Team</a></li>
