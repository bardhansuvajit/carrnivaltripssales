            ...
            <div>
              <div>
                <a class="logo" href="index.php">
                  ...
                  <h2 class="pt-3">Manager Login</h2>
                </a>
              </div> 
            ...
            if(!empty($_POST['email']) && !empty($_POST['password']))
             {
                ...
                $query=$conn->query("SELECT * FROM carrnivaltrips_employee WHERE email='".$email."' AND password='".$pass."'  AND designation='Manager' ");
                ...
                // echo $query;
                    ...
                    if($numrows!=0)
                    {
                        ...
                        if($email == $dbemail && $pass == $dbpassword)
                        {
                          ...
                          $_SESSION['sess_manager_user']=$email;
                          $_SESSION['sess_manager_name']=$name;
