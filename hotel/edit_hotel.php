                            ...
                            <table class="table table-bordered table-hover" id="dynamic_field">
                              ...
                              ?>
                                  ...
                                  <tr id="" class="row_item">
                                        ...
                                        <td>
                                          <select class="form-control" id="amenities" name="amenities[]"  > <option value="">Select Amenities</option><option value="Coffee Kit">Coffee Kit</option><option value="Geyser">Geyser</option><option value="Wi-Fi">Wi-Fi</option><option value="TV">TV</option>
                                          </select>
                                        </td>
