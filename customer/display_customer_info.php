  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>CarrnivalTrips Clients</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item active">CarrnivalTrips Clients</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">CarrnivalTrips Clients</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-hover table-striped">
                  ...
                  <tbody>
                      ...
                      <?php
                              $product=mysqli_query($conn,"Select * from carrnivaltrips_customer order by id desc");
                              $cnt=1;
                              ...
                              ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="img/<?php  echo $row['Customer_img'];?>" style="width: 40px ; hight:40px;" >
                                    ...
                                    <td><?php  echo $row['travel_status'];?></td>

                                    <td>
                                      <a type="submit" class="btn btn-primary" value="Create Website" href="../trip/client.php?id=<?php  echo $row['id'];?>" target="_blank" >Create Website</a>
                                    ...
                                    <td>
                                        ...
                                        <a href="edit_customer_info.php?editid=<?php echo htmlentities($row['id']);?>" class="edit" title="Update" data-toggle="tooltip"  style="color:green;">Update <i class="fas fa-edit"></i></a> 
                                        <br>
                                         <a href="watch_customer_info.php?editid=<?php echo htmlentities($row['id']);?>" class="edit" title="Watch" data-toggle="tooltip"  style="color:green;">Watch <i class="fas fa-edit"></i></a>
