                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="slider-home1 absulate overflow-hidden swiper-slide">
                                <div class="silider-image">
                                    <img src="../package/img/<?php echo $data['s1_img']; ?>" alt="Image" class="image-slide">
                                ...
                                <div class="slider-content">
                                    <div class="tf-container">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-8">
                                                <span
                                                    class="sub-title text-main font-yes fs-28-46 fadeInDown wow" style="font-size: 70px;" >Hello Tushar</span>
                            ...
                            <div class="slider-home1 relative overflow-hidden swiper-slide">
                                <div class="silider-image">
                                    <img src="../package/img/<?php echo $data['s2_img']; ?>" alt="Image" class="image-slide">
                                    <img src="./assets/images/slide/mask-slide.png" alt="Image" class="mask-slide">
                                    <img src="./assets/images/slide/mask-fly.png" alt="Image" class="mask-flane">
                                    <div class="booking-title tf-anime-rorate">
                            ...
                            <div class="slider-home1 relative overflow-hidden swiper-slide">
                                <div class="silider-image">
                                    <img src="../package/img/<?php echo $data['s3_img']; ?>" alt="Image" class="image-slide">
                                    <img src="./assets/images/slide/mask-slide.png" alt="Image" class="mask-slide">
                                    <img src="./assets/images/slide/mask-fly.png" alt="Image" class="mask-flane">
                                    <div class="booking-title tf-anime-rorate">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="center m0-auto w-text-heading">
                                            <!-- <span class="sub-title-heading text-main mb-15 wow fadeInUp animated">Explore the
                                                world</span> -->
                                            <h2 class="title-heading mb-32 fadeInUp wow" style="color:green; font-size:30px">Tushar, This is your<span
                                                                    ...
                                                                    <div class="accordion faq-list" id="accordionExample" >
                                                                        <div class="accordion-item " >
                                                                            ...
                                                                            <div id="collapseOne" class="accordion-collapse collapse relative show information-content-tour pb-3"
                                                                                ...
                                                                                <div class="row  pb-3 itinerary_ph_view">
                                                                                             <?php
                                                                                    $daywise_1_img=mysqli_query($conn,"Select * from carrrnivaltrips_package_itinerary_img where package_id='".$data['id'] ."' AND day_no='1' ");
                                                                                    $cnt=1;
                                                                                    ...
                                                                                    if($row3_1_img>0)
                                                                                     {
                                                                                          $row3_1_img=mysqli_fetch_array($daywise_1_img)
                                                                                    ...
                                                                                    <img  src="../package/img/<?php echo $row3_1_img['img_1'] ?>" style=""  class=" responsive itinerary_ph_img img-fluid" >
                                                                                    </div>

                                                                                    <div class="col-4 px-0" >
                                                                                    <img class=" responsive itinerary_ph_img img-fluid" src="../package/img/<?php echo $row3_1_img['img_2'] ?>" style=" " >
                                                                                    </div>


                                                                                    <div class="col-4 px-0" >
                                                                                    <img class=" responsive itinerary_ph_img img-fluid" src="../package/img/<?php echo $row3_1_img['img_3'] ?>" style=" " >
                                                                                    </div>
                                                                            ...
                                                                            <?php
                                                                            $daywise_1=mysqli_query($conn,"Select * from carrrnivaltrips_package_itinerary where package_id='".$data['id'] ."' AND day_no='1' order by rank_1");
                                                                            $cnt=1;
                                                                                ...
                                                                                <div class="accordion-body px-4 pb-3" style="">
                                                                                    <ul class="listing-clude">
                                                                                        <li class="flex-three">
                                                                                            ...
                                                                                            <p ><i class="icon-Vector-7" style="color:green; margin-right: 10px;"></i>  <?php echo $row3_1['name']; ?></p>
                                                                                        </li>
                                                                                    </ul>
                                                                        ...
                                                                        <div class="accordion-item ">
                                                                            ...
                                                                            <div id="collapse<?php echo $i; ?>" class="accordion-collapse relative collapse"
                                                                                ...
                                                                                <div class="row  pb-3 itinerary_ph_view">
                                                                                             <?php
                                                                                    $daywise_2_img=mysqli_query($conn,"Select * from carrrnivaltrips_package_itinerary_img where package_id='".$data['id'] ."' AND day_no='$i' ");
                                                                                    $cnt=1;
                                                                                    ...
                                                                                    if($row3_2_img>0)
                                                                                     {
                                                                                          $row3_2_img=mysqli_fetch_array($daywise_2_img)
                                                                                    ...
                                                                                    ?>
                                                                                     ...
                                                                                     <div class="col-4 px-0" >
                                                                                    <img class=" responsive itinerary_ph_img" src="../package/img/<?php echo $row3_2_img['img_1'] ?>" >
                                                                                    </div>

                                                                                    <div class="col-4 px-0" >
                                                                                    <img class=" responsive itinerary_ph_img" src="../package/img/<?php echo $row3_2_img['img_2'] ?>" >
                                                                                    </div>


                                                                                    <div class="col-4 px-0" >
                                                                                    <img class=" responsive itinerary_ph_img " src="../package/img/<?php echo $row3_2_img['img_3'] ?>" >
                                                                                    </div>
                                                                            ...
                                                                            <?php
                                                                            $daywise_2=mysqli_query($conn,"Select * from carrrnivaltrips_package_itinerary where package_id='".$data['id'] ."' AND day_no='$i' order by rank_1");
                                                                            $cnt=1;
                                                                                ...
                                                                                <div class="accordion-body px-4 pb-3">
                                                                                    <ul class="listing-clude">
                                                                                        <li class="flex-three mb-1">
                                                                                            ...
                                                                                            <p> <i class="icon-Vector-7" style="color:green; margin-right: 10px;"></i>  <?php echo $row3_2['name']; ?></p>
                                                                                        </li>
                                                                                    </ul>
                ...
                <section class="widget-destination p_t-20">
                    ...
                    <div class="tf-container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="center m0-auto w-text-heading mb-40">
                                    ...
                                    <h2 class="title-heading fadeInUp wow">Activity Details at <?php echo $data['package_name']; ?></h2>
                                </div>
                            </div>
                        ...
                        <div class="grid-three-destination mb-30" >
                             ...
                             <?php
                                $activity=mysqli_query($conn,"Select * from carrrnivaltrips_package_activities where package_id='".$data['id'] ."' order by rank_1 ");
                                $cnt=1;
                            ...
                            ?>
                                    ...
                                    <div class="tf-widget-destination wow fadeInUp animated " data-wow-delay="0.1s" style="margin-top: -15px;">
                                        <a href="#" class="destination-imgae" style="border-radius: 20px;">
                                            ...
                                            <img class="rounded" src="../package/activities_img/<?php echo $row3['img'] ?>" alt="" style="height: 270px; " >
                                        </a>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="center m0-auto w-text-heading">
                                    <!-- <span class="sub-title-heading text-main mb-15 fadeInUp wow">Explore the
                                        world</span> -->
                                    <h2 class="title-heading mb-40 fadeInUp wow">Special Experiences <span
                                            class="text-gray font-yes">At</span> <?php echo $data['package_name']; ?></h2>
                                </div>
                            ...
                            <?php
                                $activity_4=mysqli_query($conn,"Select * from carrrnivaltrips_package_special_experiences where package_id='".$data['id'] ."'  order by rank_1");
                                $cnt=1;
                                                ...
                                                <div class="col-sm-6 col-lg-3">
                                                    <div class="tour-listing wow fadeInUp animated "
                                                        ...
                                                        <a href="#" class="tour-listing-image">
                                                            ...
                                                            <img src="../package/activities_img/<?php echo $row4['img'] ?>"
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="center m0-auto w-text-heading">
                                    <!-- <span class="sub-title-heading text-main mb-15 wow fadeInUp animated">Explore the
                                        world</span> -->
                                    <h2 class="title-heading mb-40 wow fadeInUp animated">Best Scenic Places <span
                                            class="text-gray font-yes">of</span> <?php echo $data['package_name']; ?></h2>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                             ...
                             <?php
                                $activity_7=mysqli_query($conn,"Select * from carrrnivaltrips_package_best_scenic_places where package_id='".$data['id'] ."' order by rank_1");
                                $cnt=1;
                            ...
                            <div class="col-md-4 wow fadeInUp animated mb-2" data-wow-delay="0.1s" >
                                <div class="tf-widget-blog blog-style" style="border-radius: 10px;">
                                    <a href="#" class="blog-image" style="border-radius: 10px;">
                                        <img src="../package/activities_img/<?php echo $row7['img'] ?>" alt="" style="height: 270px;">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="center m0-auto w-text-heading">
                                   <!--  <span class="sub-title-heading text-main mb-15 fadeInUp wow">Explore the
                                        world</span> -->
                                    <h2 class="title-heading mb-40 fadeInUp wow">Adventure Activities <span
                                            class="text-gray font-yes">At</span> <?php echo $data['package_name']; ?></h2>
                                </div>
                                <div class="tab-tour-list">
                            ...
                            <?php
                                $activity_8=mysqli_query($conn,"Select * from carrrnivaltrips_package_adventure_activities where package_id='".$data['id'] ."' order by rank_1");
                                $cnt=1;
                                                ...
                                                <div class="col-sm-6 col-lg-3">
                                                    <div class="tour-listing wow fadeInUp animated "
                                                        ...
                                                        <a href="#" class="tour-listing-image">
                                                            ...
                                                            <img src="../package/activities_img/<?php echo $row8['img'] ?>"
                                                                alt="Image Listing" style="height: 250px;" >
                            ...
                            <div class="col-lg-7 content-banner-contact">
                                <div class="mb-32">
                                    <!-- <span
                                        ...
                                        the
                                        world</span> -->
                                    <h2 class="title-heading text-white wow fadeInUp animated">Hi Tushar, I am <?php if($data_2['contact_person']) {?><?php echo $data_2['contact_person']; ?><?php }else{ ?>Richa <?php } ?><br><?php if($data_2['contact_text']) {?><?php echo $data_2['contact_text']; ?><?php }else{ ?>NEED MORE CUSTOMIZATION CONNECT WITH OUR DESTINATION EXPERT <?php } ?></h2>
                                </div>
