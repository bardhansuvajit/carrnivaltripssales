                                                                    ...
                                                                    <div class="accordion faq-list" id="accordionExample" >
                                                                        <div class="accordion-item " >
                                                                            ...
                                                                            <div id="collapseOne" class="accordion-collapse collapse relative show information-content-tour pb-3"
                                                                                ...
                                                                                <div class="row  pb-3 itinerary_ph_view">
                                                                                             <?php
                                                                                    $daywise_1_img=mysqli_query($conn,"Select * from carrnivaltrips_lead_itinerary_sightseeing_img where lead_id='".$data['id'] ."' AND day_no='1' limit 3");
                                                                                    $cnt=1;
                                                                            ...
                                                                            <?php
                                                                            $daywise_1=mysqli_query($conn,"Select * from carrnivaltrips_lead_itinerary where lead_id='".$data['id'] ."' AND day_no='1' order by id");
                                                                            $cnt=1;
                                                                        ...
                                                                        <div class="accordion-item ">
                                                                            ...
                                                                            <div id="collapse<?php echo $i; ?>" class="accordion-collapse relative collapse"
                                                                                ...
                                                                                <div class="row  pb-3 itinerary_ph_view">
                                                                                             <?php
                                                                                    $daywise_2_img=mysqli_query($conn,"Select * from carrnivaltrips_lead_itinerary_sightseeing_img where lead_id='".$data['id'] ."' AND day_no='$i' limit 3");
                                                                                    $cnt=1;
                                                                            ...
                                                                            <?php
                                                                            $daywise_2=mysqli_query($conn,"Select * from carrnivaltrips_lead_itinerary where lead_id='".$data['id'] ."' AND day_no='$i' order by id");
                                                                            $cnt=1;
                                                        ...
                                                        <div class="tour-listing-content">
                                                            ...
                                                            <div class="flex-two">
                                                                <div class="price-box flex-three">
                                                                    <p>From <span class="price-sale">Rs.<?php echo $row4['price'] ?></span></p>
