                        ...
                        <div class="card-body" > 
                              ...
                              <div class="card-body">
                                <!-- <div id="sightseeing_hotel_Container"> -->
                                  <div>
                                    <input id="sightseeing_hotel_Container" value=""></input>
                                    <script type="text/javascript">
                                         var x= document.getElementById("sightseeing_hotel_Container").value ;
                                         // var hotel_value = document.getElementById("sightseeing_hotel_Container").value;
                                         document.write(x);
                                          // <?php $sql5='hotel_value';?> 
                                    </script>
                                  ...
                                  <?php 
                                    ...
                                    // $sql5=" ";
                                    // $sql5= '<span id="sightseeing_hotel_Container"></span>'; 

                                    echo gettype($sql5) . "<br>";
                                    // $sql5=strval($sql5);
                                    // $sql5='"'.$sql5.'"';


                                    $sql5 = str_replace("\n", "", $sql5);
                                    $sql5 = str_replace("\r", "", $sql5);



// $sql5 = json_encode($sql5);
...
echo $sql5;
  ...
  $connection = new mysqli("localhost", "root", "", "carrnivaltrips");

                                    if ($connection->connect_error) {
                                        die("Connection failed: " . $connection->connect_error);
                                    }

                                    // $sql6 = "SELECT * FROM carrnivaltrips_hotel";
                                    $product_6 = $connection->query("$sql5");
                                    ...
                                    echo $sql5 . "<br>" ;
                                  // $product_5=mysqli_query($conn,"select DISTINCT name FROM carrnivaltrips_hotel ");
                                  // $product_5=mysqli_query($conn,"select DISTINCT name FROM carrnivaltrips_hotel ");
                                    ...
                                    if ($product_6->num_rows > 0) {
                                        while ($row_5 = $product_6->fetch_assoc()) {
                                            // Process each row
                          ...
                          <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div id="" class="row">
                                   ...
                                   <div class="form-check form-check-inline bg-primary  m-1 col-sm-4"  style="padding:5px 15px 5px 15px; border-radius:5px;" >
                                    <!-- <input class="form-check-input me-2" id="lead_sightseeing_img_<?php // echo $row_4['id'] ; ?>"  type="checkbox" data-filter="lead_sightseeing_img" value="<?php // echo $row_4['name'] ; ?>"> --><label class="form-check-label" for="lead_sightseeing_img_<?php echo $row_4['id'] ; ?>"><img src="../../hotel/img/<?php echo $row_4['hotel_img1'] ; ?>" style="width: 100%; hight:100px; border-radius: 5px; margin-top:3px;" height="80px" ><span class="orm-check form-check-inline bg-light " style="padding:2px 5px; border-radius:5px;  cursor: pointer; position: relative; left: 105px; "><a  onclick="del_lead_sightseeing_img(<?php echo $row_4['id'] ; ?>)"><i class="icon-trash" style="color:red;"></i></a></span></label>
                                   </div>
                    ...
                    beforeSend:function () {
                      ...
                      success: function (res) {
                        try {
                            ...
                            // document.getElementById("sightseeing_hotel_Container").value = html(products);
                            // $('#sightseeing_hotel_Container').attr("value",(products));
                            // $("#pagination").html(pagination);
                            ...
                            .then(sightseeing_hotel_Container => sightseeing_hotel_Container.text())
                            .then(data => {
                                document.getElementById('sightseeing_hotel_Container').innerText = data;
                            })
   ...
   <!--  <script type="text/javascript">
        ...
        (() => { 
            ...
            const classFilter = className => {
                  const filter = [];
                  $('.' + sightseeing_hotel + ':click').each(function () {
                      filter.push($(this).val());
                  });
                  return filter;
              }
                ...
                $.ajax({
                 ...
                 $.ajax({
                  ...
                  $.ajax({
                    ...
                    beforeSend:function () {
                        $("#sightseeing_hotel_Container_1").html(`<div class="card min-h-400px col-lg-12">
                                                    <div class="card-body justify-align-center">
                                                        <div class="spinner-border text-success" role="status">
                                                    </div>
                                                </div>`);
