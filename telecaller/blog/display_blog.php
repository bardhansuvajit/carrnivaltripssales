                    ...
                    <div class="dt-ext table-responsive theme-scrollbar">
                      <table class="display" id="export-button">
                        ...
                        <tbody>
                           ...
                           <?php
                            $blog=mysqli_query($conn,"Select * from fishfed_blog ");
                            $cnt=1;
                            ...
                            ?>
                             ...
                             <tr>
                                    <td><?php echo $cnt;?></td>
                                    <td> <img class="img-fluid table-avtar" src="../../img/<?php echo $row['blog_img'];?>" alt="Blog Image"></td>
                                    <td><?php  echo $data['name'];?></td>
                                    <td><?php  echo $row['blog_title'];?></td>
                                    <td><?php  echo $row['blog_link'];?></td>
                                    <td><?php  echo $row['blog_post_time'];?></td>
                                    
                                    <td>
                                       <ul class="action"> 
                                          <li class="edit"> <a href="edit_blog.php?editid=<?php echo htmlentities($row['blog_id']);?>"><i class="icon-pencil-alt"></i></a></li>
                                          <li class="delete" ><a href="php_action/delete_blog.php?delid=<?php echo htmlentities($row['blog_id']);?>" onclick="return confirm('Do you really want to Delete ?');"><i class="icon-trash"></i></a></li>
                                      </ul>
                                    </td>  
                                </tr>
