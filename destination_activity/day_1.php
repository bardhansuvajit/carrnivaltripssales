...
if(isset($_POST['activity_update']))
{
    ...
    if($_POST['package_id']!="") 
    {
        ...
        // Delete data
        $qys = "DELETE FROM carrrnivaltrips_package_itinerary where package_id='".$_POST['package_id']."' and day_no='$day_no'";
        ...
        foreach($_POST['name'] as $key=>$value) 
        {
            ...
            $query1="INSERT INTO carrrnivaltrips_package_itinerary (package_id,name, rank, img ) VALUES ('".$_POST['package_id']."', '".$_POST['name'][$key]."'  , '".$_POST['rank'][$key]."'  ,  '$new_img1' )";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Update Package Day <?php echo $day_no; ?></h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item active">Update Package Day <?php echo $day_no; ?></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                            ...
                            <table class="table table-bordered" id="dynamic_field">
                                ...
                                <?php
                                      ...
                                      if($_GET['id'] !="")
                                      {
                                        ...
                                        $product = "SELECT * FROM carrrnivaltrips_package_itinerary WHERE  package_id='".$_GET['id']."'";
                                    ...
                                    ?>
                                            <tr id="row<?php echo $i-1;?>" class="row_item">
                                                ...
                                                <td>
                                                    <input  type="text" class="form-control" id="validationCustom02" value="<?php echo $row_product['rank'];?>" name="rank[]" >
                                                </td>     
                              ...
                              ?>
                                  ...
                                  <tr id="" class="row_item">
                                        ...
                                        <td>
                                              ...
                                              <input  type="text" class="form-control" id="validationCustom02"  name="rank[]" >
                                        </td>     
