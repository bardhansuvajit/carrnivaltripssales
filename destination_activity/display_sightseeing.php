  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>CarrnivalTrips Activity</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item active">CarrnivalTrips Activity</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">CarrnivalTrips Activity</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-hover table-striped">
                  ...
                  <tbody>
                      ...
                      <?php
                              $product=mysqli_query($conn,"Select DISTINCT destination from carrnivaltrips_sightseeing order by id ");
                              $cnt=1;
                              ...
                              ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php
                                            $product_1=mysqli_query($conn,"Select * from carrnivaltrips_sightseeing where destination='".$row['destination']."' order by id ");
                                            $cnt=1;
                                            ...
                                            <span class="">
                                              <a type="submit" class="btn btn-primary m-1" value="Add Activity" href="slide4.php?id=<?php  echo $row_1['id'];?>" ><?php  echo $row_1['location_wise'];?></a>
                                            </span>
