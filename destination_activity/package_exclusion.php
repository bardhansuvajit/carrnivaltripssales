  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Update Package Exclusion</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item active">Update Package Exclusion</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Update Package Exclusion</h3>
              </div>
              <!-- /.card-header -->
                ...
                <div class="card-body">
                  ...
                  <form  method="POST" action="php_action/package_exclusion.php" enctype="multipart/form-data">
                      <div class="card-body">
                        ...
                        <div class="row">
                          <div class="table-responsive">
                            ...
                            <label><h3> Package Exclusion</h3></label>
                            <table class="table table-bordered table-hover" id="dynamic_field">
                                ...
                                <?php
                                      ...
                                      if($_GET['id'] !="")
                                      {
                                        ...
                                        $product = "SELECT * FROM carrrnivaltrips_destination_exclusion WHERE  destination='".$data['destination']."'";
                    ...
                    <div class="card-footer">
                       <?php
                          ...
                          { ?>
                              ...
                              <button type="submit"  name="activity_update" class="btn btn-primary float-end" value="Update"> Update Exclusion</button>
                              
                          <?php 
                          } 
                          else 
                          { ?>
                              <button type="submit"  name="activity_update" class="btn btn-primary float-end" value="Save">Save Exclusion</button>
                          <?php 
                          } ?>
                    </div>
