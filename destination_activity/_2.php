...
if(isset($_POST['activity_update']))
{
    ...
    // if($_POST['package_id']!=""  &&  $_POST['day_no']!="") 
    ...
    if($_POST['package_id']!="") 
    {
        ...
        // Delete data
        $qys = "DELETE FROM carrrnivaltrips_package_itinerary where package_id='".$_POST['package_id']."' and day_no='".$_POST['day_no']."'";
        ...
        foreach($_POST['name'] as $key=>$value) 
        {
            ...
            // $query1="INSERT INTO carrrnivaltrips_package_itinerary (package_id, day_no, name, price, rank, img ) VALUES ('".$_POST['package_id']."', '".$_POST['day_no'][$key]."'  , '".$_POST['name'][$key]."'  , '".$_POST['price'][$key]."'  , '".$_POST['rank'][$key]."'  ,  '$new_img1' )";

          $query1="INSERT INTO carrrnivaltrips_package_itinerary (package_id, day_no, name, price, rank, img ) VALUES ('".$_POST['package_id']."', '".$_POST['day_no'][$key]."'  , '".$_POST['name'][$key]."'    )";
    ...
    else
    {
         ...
         foreach($_POST['name'] as $key=>$value) 
        {
            ...
            $query1="INSERT INTO carrrnivaltrips_package_itinerary (package_id, day_no, name) VALUES ('".$_POST['package_id']."',  '".$_POST['day_no'][$key]."'  ,  '".$_POST['name'][$key]."'  )";
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Update Package Day <?php echo $day_no; ?></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                ...
                <div class="card-body">
                  ...
                  <form  method="POST" action="" enctype="multipart/form-data">
                      <div class="card-body">
                         ...
                         <input type="hidden" name="day_no" value="<?php echo $day_no ?>">
                        ...
                        <div class="row">
                          <div class="">
                            ...
                            <label><h3>Day <?php echo $day_no; ?></h3></label>
                            <table class="table table-bordered" id="dynamic_field">
                                <tr>
                                    <th><label for="Size" class="form-label">Activities</label></th>
                                    <!-- <th><label for="Size" class="form-label">Price</label></th> -->

                                    <!-- <th><label for="Size" class="form-label">Upload Img</label></th> -->
                                    <!-- <th style="width:100px;"><label for="Size" class="form-label">Image</label></th> -->
                                    <!-- <th><label for="Size" class="form-label">Rank</label></th> -->
                                    ...
                                    ?>
                                            <tr id="row<?php echo $i-1;?>" class="row_item">
                                               ...
                                               <!--  <td>
                                                ...
                                                <!-- <td>
                                                      <img width="50" height="50" class="mt-3" src="activities_img/<?php // echo $row_product['img'];?>">
                                                </td> -->

                                                <!-- <td>
                                                    <input  type="number" class="form-control" id="validationCustom02" value="<?php echo $row_product['rank'];?>" name="rank[]" style="width: 80px;" >
                                                </td>  -->
                              ...
                              ?>
                                  ...
                                  <tr id="" class="row_item">
                                        ...
                                        <td>  
                                                  <img width="50" height="50" class="mt-3" src="activities_img/">
                                        </td> -->

                                         <!-- <td>
                                                
                                              <input  type="number" class="form-control" id="validationCustom02"  name="rank[]" style="width: 80px;">
                                          </td>  -->
...
$(document).ready(function(){
 ...
 <script>
        $(document).ready(function () {
            ...
            // $('#add').click(function () {
            //     i++;
            //     $('#dynamic_field').append('<tr id="row'+i+'"  class="row_item"><td><input type="text" class="form-control" id="validationCustom01"  value="" name ="name[]" placeholder="" required></div></td> <td><input  type="text" class="form-control" id="validationCustom02" value="" name="price[]" ></td> <td><input type="file" class="form-control" name="img[]" id="images" ></td><td><img width="50" height="50" class="mt-3" src="activities_img/"></td><td><input  type="number" class="form-control" id="validationCustom02" value="" name="rank[]" style="width: 80px;" ></td><td><button type="button" name="remove" style="margin-top:27px;" id="'+i+'" class="btn btn-danger btn_remove"><i class="fa fa-trash"></i></button></td></tr>');
            // });

             $('#add').click(function () {
                i++;
                $('#dynamic_field').append('<tr id="row'+i+'"  class="row_item"><td><input type="text" class="form-control" id="validationCustom01"  value="" name ="name[]" placeholder="" required></td> <td><button type="button" name="remove" style="margin-top:27px;" id="'+i+'" class="btn btn-danger btn_remove"><i class="fa fa-trash"></i></button></td></tr>');
            });
