...
if(isset($_POST['activity_update']))
{
    ...
    if($_POST['package_id']!="") 
    {
        ...
        // Delete data
        $qys = "DELETE FROM carrrnivaltrips_destination_activities where package_id='".$_POST['package_id']."'";
        ...
        foreach($_POST['name'] as $key=>$value) 
        {
            ...
            $query1="INSERT INTO carrrnivaltrips_destination_activities (package_id,name, price, img, discount, rank_1, destination, location_wise ) VALUES ('".$_POST['package_id']."', '".$_POST['name'][$key]."'  , '".$_POST['price'][$key]."'  ,  '$new_img1' , '".$_POST['discount'][$key]."' , '".$_POST['rank_1'][$key]."'  , '".$_POST['destination']."' , '".$_POST['location_wise']."' )";
