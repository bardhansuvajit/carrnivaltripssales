...
if(isset($_POST['activity_update']))
{
    ...
    if($_POST['package_id']!="") 
    {
        ...
        // Delete data
        $qys = "DELETE FROM carrrnivaltrips_destination_special_experiences where package_id='".$_POST['package_id']."'";
        ...
        foreach($_POST['name'] as $key=>$value) 
        {
            ...
            $query1="INSERT INTO carrrnivaltrips_destination_special_experiences (package_id,name, price, img,discount,rank_1 , destination, location_wise ) VALUES ('".$_POST['package_id']."', '".$_POST['name'][$key]."'  , '".$_POST['price'][$key]."'  ,  '$new_img1', '".$_POST['discount'][$key]."' , '".$_POST['rank_1'][$key]."' , '".$_POST['destination']."' , '".$_POST['location_wise']."' )";
            ...
            if($result1 === TRUE)
            {
                // header("location: users-view.php?id=$package_id");
                 ...
                 echo "<script>window.location='slide5.php?id=$package_id';</script>";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Update Package Slide 5</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item active">Update Package Slide 5</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Update Package Slide 5</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                      ...
                      <div class="card-body">
                        ...
                        <div class="row">
                          <div class="table-responsive">
                            ...
                            <label><h3>Special Experiences</h3></label>
                            <table class="table table-bordered table-hover" id="dynamic_field">
                                ...
                                <?php
                                      ...
                                      if($_GET['id'] !="")
                                      {
                                        ...
                                        $product = "SELECT * FROM carrrnivaltrips_destination_special_experiences WHERE  package_id='".$_GET['id']."'";
