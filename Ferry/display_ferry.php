...
?>
 ...
 <?php 
    ...
    if(isset($_GET['editid']))
    {
      ...
      $ferry_data_row = mysqli_query($conn, "select * from carrnivaltrips_ferry_rent where id='$eid' ");
      $ferry_data= $ferry_data_row->fetch_assoc();

    }



    if(isset($_GET['ferry_type_id']))
    {

      $ferry_type_id = $_GET['ferry_type_id'];
                  
      $ferry_type_data_row = mysqli_query($conn, "select * from carrnivaltrips_ferry_type where id='$ferry_type_id' ");
      $ferry_type_data= $ferry_type_data_row->fetch_assoc();
...
<?php 
  ...
  if (isset($_POST['submit_ferry_type']))
  {
      if(!empty($_POST['ferry_type']))
     {
        
          $ferry_type=$_POST['ferry_type'];
                  
                
                $query=$conn->query("SELECT * FROM carrnivaltrips_ferry_type WHERE ferry_type='".$ferry_type."'  ");
                $numrows=mysqli_num_rows($query);
                if($numrows==0)
                {
                  

                    $sql="INSERT into carrnivaltrips_ferry_type(ferry_type) VALUES('$ferry_type')";
                    
                    $result=$conn->query($sql);

                    if($result)
                    {
                      echo '<script>alert("Ferry Type added")</script>';
                      // header("Location:display_ferry.php");
                    } 
                    else 
                    {
                      echo '<script>alert("Failure to added Ferry Type!")</script>';
                    }

              } 
              else
              {
                  echo "<script>alert('This Ferry Type already exists! Please try again with another.');window.location.href='display_ferry.php';</script>";
      ...
      {
        echo '<script>alert("Please Enter a Ferry Type!")</script>';
      }
  }
  ...
  if (isset($_POST['update_ferry_type']))
  {
      if(!empty($_POST['ferry_type']))
     {
          ...
          $ferry_type=$_POST['ferry_type'];
                ...
                if($numrows==0)
                {
                    ...
                    $updateSql = " update carrnivaltrips_hotel_category  set   ferry_type='$ferry_type' where id='$ferry_type_id' ";
                    $result=$conn->query($updateSql);

                    if($result)
                    {
                      echo "<script>alert('Ferry Type added');window.location.href='display_ferry.php';</script>";
                    } 
                    else 
                    {
                      echo "<script>alert('Failure to added Ferry Type!');window.location.href='display_ferry.php';</script>";
                    }
      ...
      {
        echo "<script>alert('Please Enter a Ferry Type!');window.location.href='display_ferry.php';</script>";
      }
  }
...
<?php 
  ...
  if (isset($_POST['submit_ferry_rent']))
  {
      if(!empty($_POST['sightseeing_point']) && !empty($_POST['drop_sightseeing_point']) )
      {
          ...
          $off_season_price=$_POST['off_season_price'];
                ...
                $query=$conn->query("SELECT * FROM carrnivaltrips_ferry_rent WHERE sightseeing_point='".$sightseeing_point."' AND drop_sightseeing_point='".$drop_sightseeing_point."'  AND ferry_type='".$ferry_type."' AND price='".$price."'  ");
                $numrows=mysqli_num_rows($query);
                if($numrows==0)
                {
                  

                    $sql="INSERT into carrnivaltrips_ferry_rent(ferry_type, destination, location_wise, sightseeing_point, drop_location_wise , drop_sightseeing_point, price, pick_season_price, off_season_price) VALUES('$ferry_type', '$destination', '$location_wise', '$sightseeing_point', '$drop_location_wise', '$drop_sightseeing_point', '$price', '$pick_season_price', '$off_season_price')";
                ...
                {
                    echo "<script>alert('This Point already exists! Please try again with another.');window.location.href='display_ferry.php';</script>";
  ...
  if (isset($_POST['update_ferry_rent']))
  {
      if(!empty($_POST['sightseeing_point']) && !empty($_POST['drop_sightseeing_point']) )
      {
          ...
          $off_season_price=$_POST['off_season_price'];
                ...
                // {
                    ...
                    $updateSql = " update carrnivaltrips_ferry_rent  set   ferry_type='$ferry_type',  destination='$destination',  location_wise='$location_wise',  sightseeing_point='$sightseeing_point',  drop_location_wise='$drop_location_wise',  drop_sightseeing_point='$drop_sightseeing_point',  price='$price',  pick_season_price='$pick_season_price',  off_season_price='$off_season_price' where id='$eid' ";
                    $result=$conn->query($updateSql);

                    if($result)
                    {
                      echo "<script>alert('Successfully Update');window.location.href='display_ferry.php';</script>";
                      
                    } 
                    else 
                    {
                      echo "<script>alert('Faild to Update Data');window.location.href='display_ferry.php';</script>";
                    }
      ...
      {
        echo "<script>alert('Please Enter All Required Data !');window.location.href='display_ferry.php';</script>";
      }
  }
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>CarrnivalTrips Ferry</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item active">CarrnivalTrips Ferry</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <div class="pb-3">
                  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add_ferry_type"
                    id="popup_update_ferry_type">
                    Add Ferry Type
                  </button>

                  <button type="button" class="btn btn-primary ml-3" data-toggle="modal" data-target="#exampleModal"
                    id="popup_update_ferry_rent">
                    Add Ferry Rent
                  </button>
            </div>
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-hover table-striped">
                  ...
                  <tbody>
                      ...
                      <?php
                              $product=mysqli_query($conn,"Select * from carrnivaltrips_ferry_rent order by id ");
                              $cnt=1;
                              ...
                              ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="display_ferry.php?editid=<?php echo htmlentities($row['id']);?>" class="edit" title="Update" data-toggle="tooltip"  style="color:green;">Update <i class="fas fa-edit"></i></a> 
                                        <br>
...
<!-- ./wrapper -->
              ...
              <div class="modal-content">
                <div class="modal-header">
                  <?php 
                    ...
                    {
                    ?>
                    <h4 class="modal-title" id="exampleModalLabel">Update Ferry Rent</h4>
                  <?php }else{ ?>
                    <h4 class="modal-title" id="exampleModalLabel">Add Ferry Rent</h4>
                  <?php } ?>
                ...
                <form action="" method="post" >
                   ...
                   <?php 
                    ...
                    ?>
                      ...
                      <div class="modal-body">
                        ...
                        <div class="form-group mb-2">
                            <label>Ferry Type</label>
                            <select class="form-control" id="ferry_type" name="ferry_type" required>
                                <option value="<?php echo $ferry_data['ferry_type']; ?>"><?php echo $ferry_data['ferry_type']; ?></option>  
                                <?php
                                $product_1=mysqli_query($conn,"Select * from carrnivaltrips_ferry_type order by id ");
                                $cnt=1;
                                ...
                                <option value="<?php echo $row_1['ferry_type']; ?>"><?php echo $row_1['ferry_type']; ?></option>
                                <?php }} ?>
                            </select>
                        </div>
                        ...
                        <div class="form-group mb-2">
                              <label >Destination</label>
                                ...
                                <option value="<?php echo $ferry_data['destination']; ?>"><?php echo $ferry_data['destination']; ?></option>  
                                <?php
                        ...
                        <div class="form-group mb-2">
                          <label>Sightseeing</label>
                              ...
                              <option value="<?php echo $ferry_data['location_wise']; ?>"><?php echo $ferry_data['location_wise']; ?></option> 
                            </select>
                        ...
                        <div class="form-group mb-2">
                            ...
                            <select id="pick_sightseeing_point_edit"  class="form-control"  name="sightseeing_point">
                              <option value="<?php echo $ferry_data['sightseeing_point']; ?>"><?php echo $ferry_data['sightseeing_point']; ?></option>
                            </select>
                         ...
                         <div class="form-group mb-2">
                            <label>Price</label>
                            <input type="text" name="price" class="form-control" value="<?php echo $ferry_data['price'] ?>" > 
                         </div>
                    ...
                    <input type="submit" class="btn btn-primary" name="update_ferry_rent" value="Update">
                      ...
                      ?>
                        <div class="modal-body">
                          ...
                          <div class="form-group mb-2">
                              <label>Ferry Type</label>
                              <select class="form-control" id="ferry_type" name="ferry_type" required>
                                  <option value="">Select Ferry Type</option> 
                                  <?php
                                  $product_1=mysqli_query($conn,"Select * from carrnivaltrips_ferry_type order by id ");
                                  $cnt=1;
                                  $row_1=mysqli_num_rows($product_1);
                    ...
                    <div class="modal-footer">
                    <input type="submit" class="btn btn-primary" name="submit_ferry_rent" value="Save">
  ...
  <!--Modal for Add Ferry type--->
  <div class="modal fade" id="add_ferry_type" tabindex="-1" role="dialog" aria-labelledby="add_ferry_type"
            aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title" id="exampleModalLabel">Add Ferry Type</h4>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                   ...
                   <?php 
                    ...
                    ?>
                      ...
                      <div class="modal-body">
                        <div class="form-group mb-2">
                              <label >Ferry Type</label>
                              <input type="text" name="ferry_type" class="form-control" value="<?php echo $ferry_type_data['ferry_type'] ?>" >             
                        </div>
                    ...
                    <div class="modal-footer">
                    <input type="submit" class="btn btn-primary" name="update_ferry_type" value="Update">
                    ...
                    else
                    {
                      ?>
                        <div class="modal-body">
                          <div class="form-group mb-2">
                                <label >Ferry Type</label>
                                <input type="text" name="ferry_type" class="form-control" required>             
                          </div>
                    ...
                    <div class="modal-footer">
                    <input type="submit" class="btn btn-primary" name="submit_ferry_type" value="Save">
   ...
   <?php
    ...
    <script type="text/javascript">
       ...
       $("document").ready(function() {
          setTimeout(function() {
              $("#popup_update_ferry_rent").trigger('click');
          },5);
      });
